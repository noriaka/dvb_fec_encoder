...
module dvbs2hdlTransmitterCore_DVB_S2_Symbol_Modulator1_new
          (clk,
           reset,
           enb,
           in0,
...
// ADD
dvbs2hdlTransmitterCore_buffInpGenAddrBPSK u_buffInpGenBPSKAddr_inst (  .clk(clk),
                                                                        .reset(reset),
                                                                        .enb(enb),
                                                                        .dataIn(dataInDelay1),  // ufix1
                                                                        .validIn(validInBPSK),  // ufix1
                                                                        .resetIn(resetIn),  // ufix1
                                                                        .addrBPSK(addrBPSK),  // ufix2
                                                                        .addrBPSKValidOut(addrBPSKValidOut)  // ufix1
                                                                        );
...
//     end
  always @(posedge clk or posedge reset)
    begin : delay_addrBPSKValidOut_process
      if (reset == 1'b1) begin
        addrBPSKValidOutDelay <= 1'b0;
      end
      else begin
        if (enb) begin
          addrBPSKValidOutDelay <= addrQPSKValidOut;
        end
      end
    end
