  ...
  always @(Enable, codeRateIdxIn, frameLength, frameTypeIn, parityLength, validateFrame) begin
    ...
    if (Enable) begin
      ...
      if (frameTypeIn) begin
        ...
        inpFrameLength_1 = t_0[{2'd0, codeRateIdxIn}];
        ...
        frameLength_next = t_0[{2'd0, codeRateIdxIn}];
        ...
        inpParityLength_1 = t_2[{2'd0, codeRateIdxIn}];
        ...
        parityLength_next = t_2[{2'd0, codeRateIdxIn}];
      end
    end
    else begin
