// -------------------------------------------------------------
// 
// File Name: F:\FileFolder\DVB\dvbs2_tx_new\hdlsrc\dvbs2hdlTransmitter\dvbs2hdlTransmitterCore\dvbs2hdlTransmitterCore_buffInpGenAddr8PSK.v
...
// -------------------------------------------------------------
// 
// Module: dvbs2hdlTransmitterCore_buffInpGenAddr8PSK
// Source Path: dvbs2hdlTransmitterCore/DVB-S2 Tx/Symbol Modulator/DVB-S2 Symbol Modulator1/buffInpGenAddr8PSK
// Hierarchy Level: 5
// Model version: 4.5
// 
// Buffer input data and generate address 8PSK
// 
// -------------------------------------------------------------
...
module dvbs2hdlTransmitterCore_buffInpGenAddr8PSK
  ...
  input   validIn;  // ufix1
  input   resetIn;  // ufix1
  output  [2:0] addr8PSK;  // ufix3
  output  addr8PSKValidOut;  // ufix1
  ...
  wire Constant1_out1_1;  // ufix1
  wire [2:0] Constant1_out1_dtc;  // ufix3
  wire [2:0] y_1;  // ufix3
  wire [2:0] Switch1_out1;  // ufix3
  wire [2:0] Switch2_out1;  // ufix3


  assign Constant_out1 = 2'b11;
  ...
  assign Logical_Operator7_out1 =  ~ resetIn;
  ...
  assign Logical_Operator9_out1 = Delay3_out1 & Delay5_out1;



  assign Logical_Operator2_out1 = Relational_Operator1_relop1 & Logical_Operator9_out1;
  ...
  assign Compare_To_Constant7_out1 = Delay7_out1 == 2'b11;
  ...
  assign y = {Constant_out1_1, Constant1_out1, Constant2_out1};
  ...
  assign Compare_To_Constant1_out1 = HDL_Counter_out1 == 2'b11;
  ...
  assign Logical_Operator15_out1 = Logical_Operator2_out1 & Compare_To_Constant7_out1;



  assign switch_compare_1_1 = Logical_Operator15_out1 > 1'b0;
  ...
  assign Constant1_out1_dtc = {2'b0, Constant1_out1_1};



  assign y_1 = {Delay1_out1, Delay2_out1, Delay4_out1};
  ...
  assign Switch2_out1 = (switch_compare_1_1 == 1'b0 ? Constant1_out1_dtc :
              Switch1_out1);



  assign addr8PSK = Switch2_out1;

  assign addr8PSKValidOut = Logical_Operator2_out1;

endmodule  // dvbs2hdlTransmitterCore_buffInpGenAddr8PSK
