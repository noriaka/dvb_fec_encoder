// -------------------------------------------------------------
// 
// File Name: F:\FileFolder\DVB\dvbs2_tx_new\hdlsrc\dvbs2hdlTransmitter\dvbs2hdlTransmitterCore\dvbs2hdlTransmitterCore_buffInpGenAddr32APSK.v
...
// -------------------------------------------------------------
// 
// Module: dvbs2hdlTransmitterCore_buffInpGenAddr32APSK
// Source Path: dvbs2hdlTransmitterCore/DVB-S2 Tx/Symbol Modulator/DVB-S2 Symbol Modulator1/buffInpGenAddr32APSK
// Hierarchy Level: 5
// Model version: 4.5
// 
// Buffer input data and generate address 32APSK
// 
// -------------------------------------------------------------
...
module dvbs2hdlTransmitterCore_buffInpGenAddr32APSK
  ...
  input   validIn;  // ufix1
  input   resetIn;  // ufix1
  output  [4:0] addr32APSK;  // ufix5
  output  addr32APSKValidOut;  // ufix1
  ...
  reg  Delay6_delOut;  // ufix1
  wire Delay6_ectrl;  // ufix1
  wire Delay6_out1;  // ufix1
  reg  Delay6_last_value;  // ufix1
  wire Logical_Operator17_out1;
  wire switch_compare_1_1;
  wire Constant4_out1_1;  // ufix1
  wire [4:0] Constant4_out1_dtc;  // ufix5
  wire [4:0] y_1;  // ufix5
  ...
  assign Logical_Operator14_out1 =  ~ resetIn;
  ...
  always @(posedge clk or posedge reset)
    begin : Delay9_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          Delay9_out1 <= Logical_Operator14_out1;
        end
      end
    end
  ...
  assign Logical_Operator13_out1 = Delay3_out1 & Delay9_out1;



  assign Logical_Operator2_out1 = Relational_Operator1_relop1 & Logical_Operator13_out1;
  ...
  assign Compare_To_Constant4_out1 = Delay7_out1 == 3'b101;
  ...
  assign y = {Constant_out1_1, Constant1_out1, Constant2_out1, Constant3_out1, Constant4_out1};
  ...
  assign Compare_To_Constant3_out1 = HDL_Counter_out1 == 3'b101;



  assign Logical_Operator10_out1 = validIn & Compare_To_Constant3_out1;



  assign Logical_Operator11_out1 = Logical_Operator2_out1 | Logical_Operator10_out1;



  assign Delay6_ectrl = (Logical_Operator11_out1 == 1'b0 ? Delay6_delOut :
              dataIn);



  always @(posedge clk or posedge reset)
    begin : Delay6_lowered_process
      if (reset == 1'b1) begin
        Delay6_delOut <= 1'b0;
      end
      else begin
  ...
  assign Delay6_out1 = (Logical_Operator11_out1 == 1'b0 ? Delay6_last_value :
              Delay6_delOut);



  assign Logical_Operator17_out1 = Logical_Operator2_out1 & Compare_To_Constant4_out1;



  assign switch_compare_1_1 = Logical_Operator17_out1 > 1'b0;



  assign Constant4_out1_1 = 1'b0;



  assign Constant4_out1_dtc = {4'b0, Constant4_out1_1};



  assign y_1 = {Delay1_out1, Delay2_out1, Delay4_out1, Delay5_out1, Delay6_out1};
  ...
  assign Switch_out1 = (switch_compare_1_1 == 1'b0 ? Constant4_out1_dtc :
              Switch1_out1);



  assign addr32APSK = Switch_out1;

  assign addr32APSKValidOut = Logical_Operator2_out1;

endmodule  // dvbs2hdlTransmitterCore_buffInpGenAddr32APSK
