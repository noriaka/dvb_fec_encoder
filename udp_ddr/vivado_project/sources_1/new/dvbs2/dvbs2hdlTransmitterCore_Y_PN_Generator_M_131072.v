// -------------------------------------------------------------
// 
// File Name: F:\FileFolder\DVB\dvbs2_tx_new\hdlsrc\dvbs2hdlTransmitter\dvbs2hdlTransmitterCore\dvbs2hdlTransmitterCore_Y_PN_Generator_M_131072.v
...
module dvbs2hdlTransmitterCore_Y_PN_Generator_M_131072
  ...
  assign InitStates[1] = 1'b1;
  assign InitStates[2] = 1'b1;
  assign InitStates[3] = 1'b1;
  assign InitStates[4] = 1'b1;
  assign InitStates[5] = 1'b1;
  assign InitStates[6] = 1'b1;
  assign InitStates[7] = 1'b1;
  assign InitStates[8] = 1'b1;
  assign InitStates[9] = 1'b1;
  assign InitStates[10] = 1'b1;
  assign InitStates[11] = 1'b1;
  assign InitStates[12] = 1'b1;
  assign InitStates[13] = 1'b1;
  assign InitStates[14] = 1'b1;
  assign InitStates[15] = 1'b1;
  assign InitStates[16] = 1'b1;
  ...
  assign TDL_12 = TDL[12];

  assign TDL_10 = TDL[10];

  assign TDL_7 = TDL[7];

  assign PNSeqOut = TDL_17 ^ (TDL_12 ^ (TDL_7 ^ TDL_10));
  ...
  assign OutputMask[3] = 1'b1;
  assign OutputMask[4] = 1'b1;
  assign OutputMask[5] = 1'b1;
  assign OutputMask[6] = 1'b1;
  assign OutputMask[7] = 1'b1;
  assign OutputMask[8] = 1'b1;
  assign OutputMask[9] = 1'b1;
  assign OutputMask[10] = 1'b0;
  assign OutputMask[11] = 1'b1;
  assign OutputMask[12] = 1'b1;
  assign OutputMask[13] = 1'b0;
...
endmodule  // dvbs2hdlTransmitterCore_Y_PN_Generator_M_131072
