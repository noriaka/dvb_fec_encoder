// -------------------------------------------------------------
// 
// File Name: F:\FileFolder\DVB\dvbs2_tx_new\hdlsrc\dvbs2hdlTransmitter\dvbs2hdlTransmitterCore\dvbs2hdlTransmitterCore_User_Packet_CRC_Generator.v
...
// -------------------------------------------------------------
// 
// Module: dvbs2hdlTransmitterCore_User_Packet_CRC_Generator
// Source Path: dvbs2hdlTransmitterCore/DVB-S2 Tx/BB Frame Generator/BB Header and Data CRC Generator/Data Field 
// Generator/Packetized Streams/User Packet CRC Generato
// Hierarchy Level: 7
// Model version: 4.5
// 
...
module dvbs2hdlTransmitterCore_User_Packet_CRC_Generator
  ...
  dvbs2hdlTransmitterCore_CRCGenControl_block u_Controlsignal_inst (.clk(clk),
                                                                    .reset(reset),
                                                                    .enb(enb),
                                                                    .startIn(startIn_vld),
                                                                    .endIn(endIn_vld),
  ...
  // Select CRC output bits
  // Select CRC output bits
  dvbs2hdlTransmitterCore_CRCGenCompute_block u_ComputeCRC_inst (.clk(clk),
                                                                 .reset(reset),
                                                                 .enb(enb),
                                                                 .datainReg(datainReg),
                                                                 .validIn(validIn),
...
endmodule  // dvbs2hdlTransmitterCore_User_Packet_CRC_Generator
