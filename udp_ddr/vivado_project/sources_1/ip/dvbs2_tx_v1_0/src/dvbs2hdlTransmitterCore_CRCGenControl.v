// -------------------------------------------------------------
// 
// File Name: F:\FileFolder\DVB\dvbs2_tx_new\hdlsrc\dvbs2hdlTransmitter\dvbs2hdlTransmitterCore\dvbs2hdlTransmitterCore_CRCGenControl.v
...
module dvbs2hdlTransmitterCore_CRCGenControl
  ...
  reg  [7:0] sof_delay_register_reg;  // ufix1 [8]
    ...
    begin : sof_delay_register_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          ...
          sof_delay_register_reg[32'sd7:32'sd1] <= sof_delay_register_reg[32'sd6:32'sd0];
        end
      end
    end

  assign startOut = sof_delay_register_reg[7];
...
endmodule  // dvbs2hdlTransmitterCore_CRCGenControl
